...
class SelectTopicWiseTest extends StatelessWidget {
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return Column(
                    children: [
                      _buildTestButton(context, tests[index],username, testType, subjectId, chapt, difficulty, testType+subjectId+chapt+tests[index]),
  ...
  Widget _buildTestButton(BuildContext context, String label, String username, String testType, String subjectId, String chapt, String difficulty, String testId) {
